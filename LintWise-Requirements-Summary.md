...
| ID | Feature | Priority | Status |
|---|---------|----------|--------|
| FR9.1 | Plan Selection & Upgrade UI | HIGH | Implemented |
| FR9.2 | Stripe Payment Integration | CRITICAL | Implemented |
| FR9.3 | Invoice Generation & History | HIGH | Implemented |
| FR9.4 | Plan Cancellation | HIGH | Implemented |
| FR9.5 | Role Upgrade/Downgrade on Payment Event | CRITICAL | Implemented |
| FR9.6 | Invoice PDF Download | MEDIUM | Implemented |
...
FR9.1 (Plan Selection UI)
  → FR9.2 (Stripe Checkout Session)
  → Stripe Checkout (hosted by Stripe)
  → Stripe Webhook: checkout.session.completed
  → FR9.5 (Role Upgrade to PREMIUM)
  → FR9.3 (Invoice Generated by Stripe)
  → FR9.6 (Invoice PDF Download from Stripe)

FR9.4 (Plan Cancellation)
  → Stripe API: cancel subscription
  → Stripe Webhook: customer.subscription.deleted
  → FR9.5 (Role Downgrade to USER at term end)
```
...
| Premium Subscription | 6 | 100% | Implemented |
